...
<script  type=text/javascript> 
  ...
  hello();
      ...
      <!-- 右侧页面内容 -->
      <div class="rightDiv">
        <div class="addTypeDiv1">修改新闻分类</div>
        <form name="frm" method="post" action="/Psd1704/11ThinkPHP/ttnews/admin.php/Update/update/typeId/<?php echo ($typeId); ?>.html" onsubmit="return checkAdd()">
          <div class="addTypeDiv2">分类名：<input type="text" name="typeName" size="30" value="<?php echo ($newstypes["typeName"]); ?>"></div>
          <div class="addTypeDiv3"><input type="submit" value="修改"></div>
        </form>
      </div>
    </div>
  </body>
